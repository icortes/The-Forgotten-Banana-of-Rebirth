...
public class DiamondBananaItem extends BananaItem {
    public DiamondBananaItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context, @NotNull TooltipDisplay display, Consumer<Component> tooltip, @NotNull TooltipFlag flag) {
        tooltip.accept(Component.translatable("item.the_forgotten_banana_of_rebirth.diamond_banana.tooltip"));
    }
}
