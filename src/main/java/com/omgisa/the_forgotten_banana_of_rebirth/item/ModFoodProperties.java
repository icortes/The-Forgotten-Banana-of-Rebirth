...
public class ModFoodProperties {
    ...
    // Enchanted Durian: same base values as Durian, but always edible
    public static final FoodProperties ENCHANTED_DURIAN = new FoodProperties.Builder().nutrition(5).saturationModifier(1.0f).alwaysEdible().build();
}
